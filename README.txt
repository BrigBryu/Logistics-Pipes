...
# MODDING OR UPDATING
- The DLL is still named TransportMod.dll and the UniqueID is still bridgerbrundy.TransportMod - these are internal
  identifiers that don't need to match the display name and shouldn't be changed (changing UniqueID would break
  saves for existing users).
